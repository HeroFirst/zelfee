...
include __DIR__.'/../header-simple.php'; ?>
    ...
    <div class="page-content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="cover" style="background: url(<?=($news_item['cover_big']!='' ? $news_item['cover_big'] : $news_item['cover'])?>)">
                        <div class="overlay"></div>

                        <?php if ($news_item['type'] != '' ):?>
                            <span class="category"><?=$news_item['type_name']?></span>
                        <?php endif; ?>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="article-info margin-top-10">
                        <div class="item">
                            Опубликовано: <span><?=\Zelfi\Utils\DateHelper::getDateFromDateTIme($news_item['date_publish'])?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <?php if ($AppUser->getRole()<5 ):?>
                <div class="admin-action margin-top-10">
                    <div class="col-zs-12">
                        <div class="item">
                            <a href="/private/news/edit/<?=$news_item['id']?>" class="button-to-private">Редактировать</a>
                        </div>
