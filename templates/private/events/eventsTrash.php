    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li><a href="/private/events/all">Опубликованные</a></li>
                <li class="active"><a href="/private/events/trash">Корзина</a></li>
            </ul>
                ...
                <table data-order='[[ 2, "desc" ]]' class="table table-bordered table-striped data-table-full">
                    ...
                    <?php if ($events) foreach ($events as $index => $event): ?>
                        <tr>
                            ...
                            <td><?=\Zelfi\Utils\DateHelper::getDateFromDateTIme($event['date_start']).' '.\Zelfi\Utils\DateHelper::getTimeFromDateTime($event['date_start'])?></td>
                            <td><?=\Zelfi\Utils\DateHelper::getDateFromDateTIme($event['date_end']).' '.\Zelfi\Utils\DateHelper::getTimeFromDateTime($event['date_end'])?></td>
                            <td><?=$event['balls']?></td>
