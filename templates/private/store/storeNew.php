...
<form id="form-place-add" action="/private/store/new" method="post" class="form-horizontal">
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <label>Баллы:</label>
                            <input name="balls" type="number" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input min="0" step="1" name="count" type="number" class="form-control" required>
                        </div>
                    </div>
