    ...
    <div class="col-md-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="/private/store/orders/new">Новые</a></li>
                <li><a href="/private/store/orders/accepted">В процесе</a></li>
                    ...
                    <?php if ($orders) foreach ($orders as $index => $order): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button data-order-id="<?=$order['id']?>" data-toggle="modal" data-target="#modalAccept" type="button" class="btn btn-warning"><i class="fa fa-check"></i></button>
